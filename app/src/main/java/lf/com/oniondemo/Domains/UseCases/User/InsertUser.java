...
public class InsertUser extends UseCase<InsertUser.RequestValue, InsertUser.ResponseValue> {
    private final MyDataSource<User> userRepository;

    public InsertUser( MyDataSource<User> userRepository) {
        super(Schedulers.io());
    ...
    protected Observable<ResponseValue> executeUseCase(RequestValue requestValue) {
        return Observable.create(e -> {
            userRepository.insert(requestValue.getUser())
